...
import sys
# Добавляем родительскую папку (aidiet-backend) в пути питона, чтобы импорты app.* работали из папки scripts/
...
if __name__ == "__main__":
    print("🚀 Старт загрузки (Ingestion Pipeline) в базу знаний AIDiet...\n")
