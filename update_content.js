...
const newAudience = `  'main-landing': {
...
code = code.replace("export const landingContent: Record<string, LandingTemplateProps> = {", "export const landingContent: Record<string, LandingTemplateProps> = {\n" + newAudience);

fs.writeFileSync(contentFile, code);
console.log("Added main-landing to landing-content.ts");
