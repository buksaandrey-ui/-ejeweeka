    ...
    <>
      ...
      <section className="relative py-32 overflow-hidden bg-[var(--bg)]">
        ...
        <div className="container mx-auto px-6 max-w-[1000px] reveal text-center">
          ...
          <p className="max-w-[700px] mx-auto text-[var(--text-muted)] mb-16 text-lg">
            Большинство приложений считает калории. ejeweeka собирает питание, готовку, покупки, активность, напитки и корректировки в один персональный план.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left mb-16">
            {/* Карточка 1 */}
            <div className="p-8 bg-[var(--surface)] border border-[var(--border)] rounded-[24px] relative overflow-hidden group hover:border-[var(--primary)]/30 transition-colors">
              <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-20 transition-opacity">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
              </div>
              <h3 className="text-xl font-bold text-[var(--text-main)] mb-6">План</h3>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-full text-sm text-[#D1D5DB]">Блюда под цель</span>
                <span className="px-3 py-1.5 bg-[var(--primary)]/10 border border-[var(--primary)]/20 rounded-full text-sm text-[var(--primary)]">Пошаговые рецепты</span>
            ...
            <div className="p-8 bg-[var(--surface)] border border-[var(--border)] rounded-[24px] relative overflow-hidden group hover:border-[#52B044]/30 transition-colors">
              ...
              <h3 className="text-xl font-bold text-[var(--text-main)] mb-6">Контекст</h3>
              <div className="flex flex-wrap gap-2">
            ...
            <div className="p-8 bg-[var(--surface)] border border-[var(--border)] rounded-[24px] relative overflow-hidden group hover:border-[#42A5F5]/30 transition-colors">
              ...
              <h3 className="text-xl font-bold text-[var(--text-main)] mb-6">Коррекция</h3>
              <div className="flex flex-wrap gap-2">
          ...
          <div className="p-6 bg-white/5 border border-white/10 rounded-2xl max-w-[800px] mx-auto">
            <p className="text-[var(--text-muted)] font-medium m-0">
              <span className="text-[var(--text-main)]">Итог:</span> ejeweeka заменяет не один трекер, а разрозненную систему из приложений, заметок, таблиц и догадок.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-24 overflow-hidden bg-[var(--bg)] border-t border-[var(--border)]">
        <div className="container mx-auto px-6 max-w-[1000px] reveal text-center">
          ...
          <p className="max-w-[700px] mx-auto text-[var(--text-muted)] mb-16 text-lg">
            ejeweeka объединяет то, что обычно живёт отдельно: блюда, рецепты, покупки, тренировки, витамины, напитки, бюджет, локацию и ограничения.
          </p>
          
          <div className="relative flex items-center justify-center min-h-[400px] py-12">
            {/* Center Node */}
            <div className="relative z-10 w-32 h-32 rounded-full bg-[var(--surface)] border-2 border-[var(--primary)] flex items-center justify-center shadow-[0_0_60px_rgba(245,146,43,0.3)]">
              <Image src="/brand/eje-app-icon-master.png" alt="ejeweeka" width={86} height={86} />
            </div>
            ...
            <div className="absolute bottom-[20%] right-[15%] px-4 py-2 bg-[var(--primary)]/10 border border-[var(--primary)]/30 rounded-full text-sm text-[var(--primary)] backdrop-blur-md">Рецепты</div>
      ...
      <section className="relative py-32 overflow-hidden bg-[var(--surface)] border-t border-[var(--border)]">
        <div className="container mx-auto px-6 max-w-[1200px] reveal text-center">
          <div className="badge-eje !bg-white/10 !border-white/20 !text-[var(--text-main)] mx-auto mb-4 w-fit">Твой контекст</div>
          <h2 className="mb-6 text-[var(--text-main)] max-w-[800px] mx-auto">Обычный трекер видит калории.<br/>ejeweeka видит контекст.</h2>
          <p className="max-w-[700px] mx-auto text-[var(--text-muted)] mb-16 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left mb-16">
            ...
            <div className="p-8 bg-white/5 border border-white/10 rounded-[24px] hover:bg-white/10 transition-colors">
              <h3 className="text-xl font-bold text-[var(--text-main)] mb-4">Ограничения без ручной проверки</h3>
              <p className="text-[var(--text-muted)] text-sm leading-relaxed">
                Веган, рыбоед, халяль, кошерное питание, без молочки или без глютена — ejeweeka учитывает это до генерации блюд, рецептов и списка покупок.
              </p>
            </div>
            
            {/* Карточка 2 */}
            <div className="p-8 bg-white/5 border border-white/10 rounded-[24px] hover:bg-white/10 transition-colors">
              <h3 className="text-xl font-bold text-[var(--text-main)] mb-4">Аллергии — в приоритете</h3>
              <p className="text-[var(--text-muted)] text-sm leading-relaxed">
            ...
            {/* Карточка 3 */}
            <div className="p-8 bg-white/5 border border-white/10 rounded-[24px] hover:bg-white/10 transition-colors">
              <h3 className="text-xl font-bold text-[var(--primary)] mb-4">Витамины связаны с рационом</h3>
              <p className="text-[var(--text-muted)] text-sm leading-relaxed">
                Если ты принимаешь добавки, ejeweeka помогает встроить их в день: например, поставить витамин D рядом с приёмом пищи, где есть жиры, а железо не ставить рядом с кофе.
              </p>
            </div>

            {/* Карточка 4 */}
            <div className="p-8 bg-white/5 border border-white/10 rounded-[24px] hover:bg-white/10 transition-colors">
              <h3 className="text-xl font-bold text-[var(--text-main)] mb-4">Голодание не ломает план</h3>
              <p className="text-[var(--text-muted)] text-sm leading-relaxed">
            ...
            {/* Карточка 5 */}
            <div className="p-8 bg-white/5 border border-white/10 rounded-[24px] hover:bg-white/10 transition-colors">
              <h3 className="text-xl font-bold text-[var(--text-main)] mb-4">Рацион без нелюбимых продуктов</h3>
              <p className="text-[var(--text-muted)] text-sm leading-relaxed">
                Убери то, что не ешь, и отметь то, что хочешь видеть чаще. ejeweeka сохранит цель, но сделает план ближе к твоей реальной жизни.
              </p>
            </div>
            ...
            <div className="p-8 bg-white/5 border border-white/10 rounded-[24px] relative overflow-hidden group hover:border-[#52B044]/30 transition-colors">
              ...
              <p className="text-[var(--text-muted)] text-sm leading-relaxed relative z-10">
                Если у тебя есть состояния или ограничения, влияющие на питание, ejeweeka учитывает их в wellness-плане. <span className="text-[var(--text-main)] font-medium">Без диагнозов, лечения и медицинских назначений.</span>
              </p>
            </div>
          </div>

          <div className="p-6 bg-[var(--surface)] border border-[#374151] rounded-2xl max-w-[800px] mx-auto shadow-2xl">
            <p className="text-[#D1D5DB] font-medium m-0 flex items-center justify-center gap-3">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2"><polyline points="20 6 9 17 4 12"></polyline></svg>
      ...
      <section className="relative py-24 overflow-hidden bg-[var(--bg)] border-t border-[var(--border)]">
        <div className="container mx-auto px-6 max-w-[1000px] reveal text-center">
          ...
          <p className="max-w-[700px] mx-auto text-[var(--text-muted)] mb-16 text-lg">
            Рацион в Москве, Дубае, Алматы или Лиссабоне не должен выглядеть одинаково. ejeweeka учитывает страну, город, привычные продукты и бюджет. Поэтому в плане появляются блюда, которые проще купить, приготовить и вписать в реальную неделю.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
            <div className="p-8 bg-[var(--surface)] border border-[var(--border)] rounded-3xl flex items-start gap-4 hover:border-[var(--primary)]/30 transition-colors">
              <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center shrink-0">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
              </div>
              <div>
                <h3 className="text-xl font-bold text-[var(--text-main)] mb-2">Страна и город</h3>
                <p className="text-[var(--text-muted)] text-sm leading-relaxed">План адаптируется под твою локацию и привычный продуктовый контекст.</p>
              </div>
            </div>

            <div className="p-8 bg-[var(--surface)] border border-[var(--border)] rounded-3xl flex items-start gap-4 hover:border-[var(--primary)]/30 transition-colors">
              <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center shrink-0">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
              </div>
              <div>
                <h3 className="text-xl font-bold text-[var(--text-main)] mb-2">Привычные продукты</h3>
                <p className="text-[var(--text-muted)] text-sm leading-relaxed">Блюда собираются из ингредиентов, которые проще найти рядом.</p>
              </div>
            </div>

            <div className="p-8 bg-[var(--surface)] border border-[var(--border)] rounded-3xl flex items-start gap-4 hover:border-[var(--primary)]/30 transition-colors">
              <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center shrink-0">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
              </div>
              <div>
                <h3 className="text-xl font-bold text-[var(--text-main)] mb-2">Бюджет и цены</h3>
                <p className="text-[var(--text-muted)] text-sm leading-relaxed">ejeweeka учитывает уровень бюджета и помогает планировать закупки без случайно дорогих корзин.</p>
              </div>
            </div>

            <div className="p-8 bg-[var(--surface)] border border-[var(--border)] rounded-3xl flex items-start gap-4 hover:border-[var(--primary)]/30 transition-colors">
              <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center shrink-0">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
              </div>
              <div>
                <h3 className="text-xl font-bold text-[var(--text-main)] mb-2">Список покупок</h3>
                <p className="text-[var(--text-muted)] text-sm leading-relaxed">Продукты группируются под план, рецепты и частоту готовки без хаоса.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-24 bg-[var(--surface)] border-t border-[var(--border)] overflow-hidden">
        <div className="container mx-auto px-6 max-w-[1200px] reveal text-center">
          ...
          <div className="hidden md:flex items-start justify-between relative max-w-[1000px] mx-auto">
            ...
            {[
              ...
              <div key={step.id} className="relative z-10 flex flex-col items-center flex-1">
                <div className="w-12 h-12 rounded-full bg-[var(--surface)] border-2 border-[var(--primary)] flex items-center justify-center text-[var(--primary)] font-bold mb-4 shadow-[0_0_20px_rgba(245,146,43,0.2)]">
                  {step.id}
                </div>
                <h4 className="text-[var(--text-main)] font-bold text-sm mb-1">{step.title}</h4>
                <p className="text-[var(--text-muted)] text-xs">{step.desc}</p>
              </div>
            ))}
          </div>
          ...
          <div className="md:hidden flex flex-col gap-6 text-left relative pl-6 max-w-[300px] mx-auto">
            ...
            {[
              ...
              <div key={step.id} className="relative z-10 flex items-center gap-6">
                <div className="w-10 h-10 rounded-full bg-[var(--surface)] border-2 border-[var(--primary)] flex items-center justify-center text-[var(--primary)] font-bold shrink-0 shadow-[0_0_15px_rgba(245,146,43,0.2)]">
                  {step.id}
                </div>
                <div>
                  <h4 className="text-[var(--text-main)] font-bold text-sm">{step.title}</h4>
                  <p className="text-[var(--text-muted)] text-xs">{step.desc}</p>
                </div>
              </div>
            ))}
...
{/* Вариант B: Неделя с ejeweeka */}
      ...
      <section className="relative py-24 overflow-hidden bg-[var(--bg)] border-t border-[var(--border)]">
        <div className="container mx-auto px-6 max-w-[1000px] reveal text-center">
          ...
          <p className="max-w-[700px] mx-auto text-[var(--text-muted)] mb-16 text-lg">
            До 3 вариантов блюд помогают не срываться с плана: выбери быстрее, сытнее, бюджетнее или лучше подходящее под тренировку. Не хочется овсянку? Открой другой вариант.
          </p>
          
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-[900px] mx-auto">
            <div className="bg-[var(--surface)] border border-[#374151] rounded-3xl overflow-hidden shadow-xl text-left flex flex-col group hover:border-[var(--primary)]/50 transition-all">
              <div className="h-32 bg-gray-800 relative">
                <div className="absolute inset-0 bg-gradient-to-t from-[#111827] to-transparent"></div>
                <div className="absolute bottom-4 left-4">
                  <span className="px-3 py-1 bg-white/10 backdrop-blur text-[var(--text-main)] text-xs rounded-full border border-white/20">Вариант 1</span>
                </div>
              </div>
              <div className="p-6 flex-1 flex flex-col">
                <h4 className="text-[var(--text-main)] font-bold mb-2">Гречка с куриным филе</h4>
                <div className="text-[var(--text-muted)] text-xs flex gap-3 mb-6"><span>420 ккал</span><span>Б: 35г</span><span>15 мин</span></div>
                <button className="mt-auto w-full py-2 bg-white/5 border border-white/10 rounded-xl text-sm font-medium text-[var(--text-main)] group-hover:bg-[var(--primary)] group-hover:text-black group-hover:border-[var(--primary)] transition-colors">Выбрать</button>
              </div>
            </div>
            
            <div className="bg-[var(--surface)] border-2 border-[var(--primary)] rounded-3xl overflow-hidden shadow-[0_0_30px_rgba(245,146,43,0.15)] text-left flex flex-col transform sm:-translate-y-4">
              <div className="h-32 bg-gray-800 relative">
                <div className="absolute inset-0 bg-gradient-to-t from-[#111827] to-transparent"></div>
                <div className="absolute bottom-4 left-4">
                  <span className="px-3 py-1 bg-[var(--primary)] text-black font-bold text-xs rounded-full">Больше белка</span>
                </div>
              </div>
              <div className="p-6 flex-1 flex flex-col">
                <h4 className="text-[var(--primary)] font-bold mb-2">Омлет с лососем и шпинатом</h4>
                <div className="text-[var(--text-muted)] text-xs flex gap-3 mb-6"><span>450 ккал</span><span>Б: 42г</span><span>10 мин</span></div>
                <button className="mt-auto w-full py-2 bg-[var(--primary)] text-black rounded-xl text-sm font-bold">Выбрать</button>
              </div>
            </div>
            ...
            <div className="bg-[var(--surface)] border border-[#374151] rounded-3xl overflow-hidden shadow-xl text-left flex flex-col group hover:border-[var(--primary)]/50 transition-all">
              <div className="h-32 bg-gray-800 relative">
                <div className="absolute inset-0 bg-gradient-to-t from-[#111827] to-transparent"></div>
                <div className="absolute bottom-4 left-4">
                  <span className="px-3 py-1 bg-white/10 backdrop-blur text-[var(--text-main)] text-xs rounded-full border border-white/20">Бюджетно</span>
                </div>
              </div>
              <div className="p-6 flex-1 flex flex-col">
                <h4 className="text-[var(--text-main)] font-bold mb-2">Овсяноблин с сыром</h4>
                <div className="text-[var(--text-muted)] text-xs flex gap-3 mb-6"><span>380 ккал</span><span>Б: 20г</span><span>5 мин</span></div>
                <button className="mt-auto w-full py-2 bg-white/5 border border-white/10 rounded-xl text-sm font-medium text-[var(--text-main)] group-hover:bg-[var(--primary)] group-hover:text-black group-hover:border-[var(--primary)] transition-colors">Выбрать</button>
              </div>
            </div>
          </div>
...
{/* Статусы */}
      <section className="section-padding bg-[var(--bg)] border-t border-[var(--border)]">
        <div className="container mx-auto px-6 max-w-[1000px] reveal">
          <h2 className="text-center mb-4">Выбери уровень сопровождения</h2>
          <p className="text-center text-[var(--text-muted)] mb-12 max-w-[600px] mx-auto">Начни с Gold-доступа на 3 дня, затем оставь тот уровень, который подходит твоему ритму.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 bg-[var(--surface)] border border-[var(--border)] rounded-3xl flex flex-col">
              ...
              <h3 className="text-[var(--text-main)] text-xl font-bold mb-4">White</h3>
              <p className="text-[#9CA3AF] text-sm mb-6 flex-1">Познакомиться с базовым планом.</p>
            </div>
            
            <div className="p-6 bg-[var(--surface)] border border-[var(--border)] rounded-3xl flex flex-col">
              <div className="text-xs text-[var(--text-muted)] uppercase tracking-wider font-bold mb-2">Система на неделю</div>
              <h3 className="text-[var(--text-main)] text-xl font-bold mb-4">Black</h3>
              <p className="text-[#9CA3AF] text-sm mb-6 flex-1">План на неделю, рецепты, покупки, витамины, Health Connect, 2 варианта блюд.</p>
            </div>

            <div className="p-6 bg-[var(--surface)] border-2 border-[var(--primary)] rounded-3xl flex flex-col relative transform md:-translate-y-4 shadow-2xl">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[var(--primary)] text-black text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-full">Рекомендуем</div>
              <div className="text-xs text-[var(--primary)] uppercase tracking-wider font-bold mb-2">Максимум</div>
              <h3 className="text-[var(--primary)] text-xl font-bold mb-4">Gold</h3>
