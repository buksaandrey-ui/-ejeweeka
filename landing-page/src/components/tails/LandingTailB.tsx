        ...
        <div className="container mx-auto px-6 max-w-[1000px] reveal">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="p-6 bg-[var(--surface)] border border-[var(--border)] rounded-3xl flex flex-col text-center">
              <h3 className="text-white text-xl font-bold mb-2">White</h3>
              <p className="text-[#F5922B] text-sm mb-4 font-bold">Понять базовый план</p>
            </div>
            <div className="p-6 bg-[var(--surface)] border border-[var(--border)] rounded-3xl flex flex-col text-center">
              <h3 className="text-white text-xl font-bold mb-2">Black</h3>
              <p className="text-[#F5922B] text-sm mb-4 font-bold">Вести неделю</p>
            </div>
            <div className="p-6 bg-[#111827] border-2 border-[#F5922B] rounded-3xl flex flex-col text-center relative shadow-2xl transform md:-translate-y-2">
              <h3 className="text-[#F5922B] text-xl font-bold mb-2">Gold</h3>
              <p className="text-[#F5922B] text-sm mb-4 font-bold">Фото-анализ и тренировки</p>
            </div>
