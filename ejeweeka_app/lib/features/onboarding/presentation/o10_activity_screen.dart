  ...
  Widget build(BuildContext context) {
    ...
    return OnboardingScaffold(
      ...
      tip: const MotivatingTipCard(
        text: 'Не нужно бегать марафоны. 30 минут ходьбы в день снижают риск сердечно-сосудистых заболеваний на 30%. Если сейчас нет готовности к тренировкам — это нормально. Начать с питания — уже 70% результата.',
      ),
    );
  }
