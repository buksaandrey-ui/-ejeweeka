...
import 'package:ejeweeka_app/features/profile/presentation/u2_personal_screen.dart';
import 'package:ejeweeka_app/features/profile/presentation/u3_health_screen.dart';
import 'package:ejeweeka_app/features/profile/presentation/u_sub_screens.dart';
  ...
  Future<void> _showDeleteDialog(BuildContext context, WidgetRef ref) async {
    ...
    if (confirm == true) {
      try {
        ...
        if (token != null) {
          await Dio().delete('${Endpoints.baseUrl}${Endpoints.authDelete}', data: {'token': token});
        }
      } catch (e) {}
