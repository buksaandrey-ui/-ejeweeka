...
import 'package:ejeweeka_app/core/router/slide_transition_page.dart';
import 'package:ejeweeka_app/features/plan/data/meal_plan_model.dart';

// Splash
import 'package:ejeweeka_app/features/onboarding/presentation/splash_screen.dart';

// Onboarding
import 'package:ejeweeka_app/features/onboarding/presentation/o0_welcome_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o1_country_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o2_goal_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o2_5_ai_personality_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o3_profile_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o4_weight_loss_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o5_restrictions_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o6_health_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o7_womens_health_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o8_meal_pattern_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o9_sleep_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o10_activity_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o11_budget_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o12_blood_tests_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o13_supplements_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o14_motivation_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o15_food_prefs_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o16_summary_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o16_5_plan_breakdown_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o17_statuswall_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/o17_5_disclaimer_screen.dart';
import 'package:ejeweeka_app/features/onboarding/presentation/activation_code_screen.dart';

// Main app shell + screens
import 'package:ejeweeka_app/shared/widgets/main_scaffold.dart';
import 'package:ejeweeka_app/features/dashboard/presentation/dashboard_screen.dart';
import 'package:ejeweeka_app/features/plan/presentation/weekly_plan_screen.dart';
import 'package:ejeweeka_app/features/plan/presentation/plan_builder_screen.dart';
import 'package:ejeweeka_app/features/shopping/presentation/shopping_list_screen.dart';
import 'package:ejeweeka_app/features/progress/presentation/progress_screen.dart';
import 'package:ejeweeka_app/features/profile/presentation/profile_screen.dart';
import 'package:ejeweeka_app/features/photo/presentation/photo_screen.dart';
import 'package:ejeweeka_app/features/chat/presentation/chat_screen.dart';
import 'package:ejeweeka_app/features/progress/presentation/hydration_screen.dart';
import 'package:ejeweeka_app/features/plan/presentation/vitamins_screen.dart';
import 'package:ejeweeka_app/features/profile/presentation/u12_status_screen.dart';
...
GoRouter appRouter(AppRouterRef ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) async {
      ...
      if (loc == Routes.splash) return null; // Let splash screen handle its own routing
