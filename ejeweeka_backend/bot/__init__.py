...
Architecture:
- User opens Telegram via deep link from iOS app: tg://resolve?domain=ejeweeka_bot&start=UUID
...
- WEBHOOK_BASE_URL — public URL for ЮKassa callbacks (e.g. https://ejeweeka-api.onrender.com)
"""
