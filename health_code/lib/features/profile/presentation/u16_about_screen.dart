        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _sectionCard(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              _linkRow('Политика конфиденциальности', 'https://healthcode.app/privacy'),
              const Divider(height: 20, color: Color(0xFFF0F0F0)),
              _linkRow('Пользовательское соглашение', 'https://healthcode.app/terms'),
              const Divider(height: 20, color: Color(0xFFF0F0F0)),
              _linkRow('Согласие на обработку данных', 'https://healthcode.app/consent'),
            ],
          ),
          const SizedBox(height: 12),
